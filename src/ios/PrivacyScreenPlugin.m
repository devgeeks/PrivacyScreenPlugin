...
- (void)pluginInitialize
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onAppWillResignActiveNotification:)
...
-(void)onAppWillResignActiveNotification:(UIApplication *)application
{
